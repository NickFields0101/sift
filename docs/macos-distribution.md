...
- `SIFT-<version>-macOS-arm64.dmg`
- `SIFT-<version>-macOS-arm64.zip`
- `SIFT-<version>-macOS-x64.dmg`
- `SIFT-<version>-macOS-x64.zip`
...
```bash
codesign --verify --deep --strict --verbose=2 "/Applications/SIFT.app"
spctl --assess --type execute --verbose=4 "/Applications/SIFT.app"
```
